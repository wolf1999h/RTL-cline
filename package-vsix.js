...
for (const item of ['package.json', 'README.md', 'CHANGELOG.md', 'LICENSE', 'icon.png']) fs.copyFileSync(path.join(root, item), path.join(extension, item));
...
<PackageManifest Version="2.0.0" xmlns="http://schemas.microsoft.com/developer/vsx-schema/2011">
  <Metadata>
    <Identity Language="en-US" Id="cline-rtl-smart-support" Version="${packageJson.version}" Publisher="local-rtl-tools" />
